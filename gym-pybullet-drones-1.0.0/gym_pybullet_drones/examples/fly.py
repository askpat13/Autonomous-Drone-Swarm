...
if __name__ == "__main__":
    ...
    START = time.time()
    #p.loadURDF("cube.urdf", [-1, -1, 0.1], p.getQuaternionFromEuler([0, 0, 0]), physicsClientId=PYB_CLIENT)
    p.loadURDF("cube.urdf", [1, 1, 0.8], p.getQuaternionFromEuler([0, 0, 0]), physicsClientId=PYB_CLIENT)
    p.loadURDF("cube.urdf", [1, -1, 0.8], p.getQuaternionFromEuler([0, 0, 0]), physicsClientId=PYB_CLIENT)
    p.loadURDF("cube.urdf", [-1, 1, 0.8], p.getQuaternionFromEuler([0, 0, 0]), physicsClientId=PYB_CLIENT)
    p.loadURDF("cube.urdf", [1, 0, 0.8], p.getQuaternionFromEuler([0, 0, 0]), physicsClientId=PYB_CLIENT)
    p.loadURDF("cube.urdf", [0, 1, 0.8], p.getQuaternionFromEuler([0, 0, 0]), physicsClientId=PYB_CLIENT)
